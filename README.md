...
When switching embedding models, re-index all documents (not incremental). Update `dimension` to match the model's output dimension. Common dimensions: qwen3-embedding:0.6b = 2560, qwen3-embedding:4b = 1024, bge-m3 = 1024, nomic-embed-text = 768.
